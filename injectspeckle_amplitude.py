...
filenames = [f for f in listdir('testsets/set5/') if isfile(join('testsets/set5/', f))]

for filename in filenames:
    im = skimage.io.imread('testsets/set5/' + filename)
    ...
    skimage.io.imsave('testsets/set_speckle_L3/' + filename, speckled_image)